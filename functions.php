...
/* =================== $TGS Edit - Add some more custom sidebars */
if ( function_exists ('register_sidebar')) {
	$shop_sidebar_args = array(
		'name'          => sprintf(__('Shop Sidebar'), $i ),
		'id'            => 'shop-sidebar',
		'description'   => '',
		'class'         => '',
...
if ( function_exists ('register_sidebar')) {
	$product_sidebar_args = array(
		'name'          => sprintf(__('Product Sidebar'), $i ),
		'id'            => 'product-sidebar',
		'description'   => '',
		'class'         => '',
		'before_widget' => '<li id="%1$s" class="widget %2$s">',
	...
	register_sidebar( $product_sidebar_args );
};
